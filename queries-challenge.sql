...
SELECT da.department_name, da.avg_salary
FROM dept_avg da
...
-- 2. Create employee_certifications table
...
-- 3. Insert at least 3 certifications
INSERT INTO certifications (name, issuing_org, level) VALUES
('Certified ScrumMaster', 'Scrum Alliance', 'Professional'),
('AWS Certified Solutions Architect', 'Amazon Web Services', 'Professional'),
('Project Management Professional', 'PMI', 'Professional'),
('Google Professional Data Engineer', 'Google Cloud', 'Professional'),
('Certified Information Systems Security Professional', 'ISC2', 'Professional')
ON CONFLICT (name) DO NOTHING;

-- 4. Insert at least 5 employee_certification records
-- Note: Assuming IDs 1-5 exist in employees table from seed data
...
-- 5. Write a query listing employees with their certifications
SELECT 
    e.first_name,
    e.last_name,
